...
test1 = NR_modify(NY_dat$time_from_first_case, NY_dat$ConfirmedCases, c(10, 10, 10))
test2 = NR_modify(NY_dat$time_from_first_case, NY_dat$Fatalities, c(1, 1, 1))

data = tibble(x = seq(0, 50, 1),
              y = (1000 / (1 + exp(-0.4 * (x - 20)))))
...
```{r}
test = newton_optimize(NY_dat$time_from_first_case, NY_dat$ConfirmedCases, c(1, 1, 1))
```
