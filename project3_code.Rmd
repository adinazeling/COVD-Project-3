...
# run K-means
load("par_new.RData")
km <- kmeans_cluster(par_new[ ,6:8], 2)
pairs(par_new[ ,6:8], lower.panel = NULL, col = km$cluster)
summary(factor(km$cluster))

#Compare to package
km_pkg <- kmeans(par_new[ ,6:8], 2)
...
mapCountryData(sPDF, nameColumnToPlot = "cluster" , addLegend = FALSE, 
               ...
               colourPalette=c('light blue','purple'),
               mapTitle = "Countries by Cluster")
